...
class P extends Component {
  render(){
    return(
      ...
      <TextInput style={{flex:1,marginLeft:10}} placeholder="请输入新密码，至少6位" secureTextEntry={true}/>
      </View>
      ...
      <TextInput style={{flex:1,marginLeft:10}} placeholder="请再次输入新密码" secureTextEntry={true}/>
      </View>
      ...
      <TouchableOpacity style={{
          ...
          marginTop:20}}>
        <Text style={{color:'white'}}>重置密码123</Text>
      </TouchableOpacity>
